  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col items-center justify-center">
        ...
        <div className="text-center">
          ...
          <span className="text-[#D74B6E] font-semibold">ऊँची उड़ान</span> एक स्मार्ट और शिक्षाप्रद स्रोत है जो आपको सबसे हाल के और महत्वपूर्ण घटनाओं, क्विज, समाचार/ब्लॉग लेखों, और पीडीएफ प्रारूप की पढ़ाई करने में मदद करता है।
