...
function ServicesOverview() {
  return (
    <div className="relative mx-auto  bg-[#161D29] font-bold py-4 px-[3%] ">
      ...
      <div className="flex flex-wrap items-center">
        <div className="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78 ">
          <div className="relative flex flex-col min-w-0 break-words bg-[#161D29] w-full mb-6  rounded-lg bg-[#161D29]">
            <Image
            width={500}
            height={500}
              alt="meow"
        ...
        <div className="w-full md:w-6/12 px-4">
          <div className="flex flex-wrap">
            <div className="w-full md:w-6/12 px-4">
              ...
              {/* </button> */}
              <Link href="/News">
                <div className="relative flex flex-col min-w-0 transition-all duration-200 hover:scale-95 w-fit shadow-md m-4 shadow-[#5B5B5B]">
                  <div className="px-4 py-5 flex-auto relative w-fit h-fit shadow-blue-700 shadow-[0px_0px_30px_0px]">
                    <div className="text-blueGray-500 p-3 text-center inline-flex items-center justify-center  w-fit h-fit mb-5 rounded-full bg-white">
